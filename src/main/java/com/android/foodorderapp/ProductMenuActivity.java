...
public class ProductMenuActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
    public List<Menu> menuList = null;
    private MenuListAdapter menuListAdapter;
    public List<Menu> itemsInCartList;
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(ProductMenuActivity.this, "Please add some items in cart.", Toast.LENGTH_SHORT).show();
                    return;
                }
                restaurantModel.setMenus(itemsInCartList);
                Intent i = new Intent(ProductMenuActivity.this, PlaceYourOrderActivity.class);
